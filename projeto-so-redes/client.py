...
def redrawWindow(win, game, p):
    ...
    if not(game.connected()):
        ...
        text = font.render("Escolha", 1, (0, 255,255))
...
btns = [Button("Pedra", 50, 500, (0,0,0)), Button("Papel", 250, 500, (255,0,0)), Button("Tesoura", 450, 500, (0,255,0))]
def main():
    run = True
    ...
    while run:
        ...
        try:
            ...
            run = False
            print("Não foi  possivel acessar o jogo")
            break
